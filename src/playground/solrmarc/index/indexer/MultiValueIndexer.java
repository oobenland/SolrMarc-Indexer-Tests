...
public class MultiValueIndexer extends AbstractValueIndexer<Collection<String>> {
    public MultiValueIndexer(final String solrFieldName, final AbstractValueExtractor<Collection<String>> extractor, final AbstractValueMapping<Collection<String>>[] mappings, final AbstractValueCollector<Collection<String>> collector) {
